                                        ...
                                        <div class="form-group mt-3">
                                            ...
                                            <select name="brand_id" class="form-control shadow" id="">
                                                ...
                                                <option value="{{ $brand->id }}"
                                                    {{ old('brands_id') == $brand->id ? 'selected' : '' }}>
                                                    {{ $brand->name }}
                                                </option>
                                                @endforeach
                                            </select>
                                            ...
                                            <div class="container">
                                                <div class="wrapper">
                                                    ...
                                                    <div class="content">
                                                        ...
                                                        <div class="text">No file choose</div>
                                                    </div>
                                                    <div id="cancel-btn"><i class="bi bi-x-lg"></i></div>
                                                    <div class="file-name">File Name</div>
                                                </div>
                                                <input type="file" hidden name="image" class="form-control shadow-none" id="default-btn">
                                ...
                                <div class="row">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody class="text-center" id="repeater-body">
                                            <tr>
                                                <td><input type="text" class="form-control shadow-none" name="specifications[0][product_code]" id=""></td>
                                                <td><textarea name="specifications[0][specs_value]" class="form-control shadow-none" id="" cols="15" rows="5"></textarea></td>
                                                <td><input type="number" class="form-control shadow-none" name="specifications[0][qty]" id=""></td>
                                                <td><input type="text" class="form-control shadow-none" name="specifications[0][purchase_price]" id=""></td>
                                                <td><input type="text" class="form-control shadow-none" name="specifications[0][sale_price]" id=""></td>
                                                <td>
                                                    <select name="specifications[0][status]" class="form-control shadow-none" id="">
                                                        <option value="" selected>Select Status</option>
                                                        <option value="new" {{ old('status') == 'new' ? 'selected' : '' }}>New</option>
                                                        <option value="second-hand" {{ old('status') == 'second-hand' ? 'selected' : '' }}>Second Hand</option>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        addRowButton.addEventListener('click', function (e) {
            ...
            repeaterBody.insertAdjacentHTML('beforeend', newRow);
            rowIndex++;
        });
