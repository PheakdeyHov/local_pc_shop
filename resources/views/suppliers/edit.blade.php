                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="phonenumber" class="form-control shadow-none @error('phonenumber') is-invalid @enderror" value="{{ $suppliers->phonenumber }}" id="">
                                @error('phonenumber')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <textarea name="address" class="form-control shadow-none @error('address') is-invalid @enderror" id="" cols="30" rows="10">{{ $suppliers->address }}</textarea>
                                @error('address')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
