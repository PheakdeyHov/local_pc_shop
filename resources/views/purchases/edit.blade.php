        ...
        <div class="container-xl mt-5">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-4">
                        <form action="{{ route('purchases.update' , $purchases->id) }}" method="POST" id="submitForm">
                            @method('PUT')
                            @csrf
                            ...
                            <div class="row">
                                <div class="form-group mt-3">
                                    ...
                                    <input type="text" name="purchase_code" class="form-control shadow-none @error('purchase_code') is-invalid @enderror" value="{{ $purchases->purchase_code }}">
                                    @error('purchase_code')
                                        ...
                                        <select name="supplier_id" class="form-control shadow-none @error('supplier_id') is-invalid @enderror" id="">
                                            ...
                                            @foreach ($suppliers as $supplier)
                                                <option value="{{ $supplier->id }}"
                                                    {{ $purchases->supplier_id == $supplier->id ? 'selected' : '' }}>
                                                    {{ $supplier->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group mt-3">
                                        ...
                                        <input type="text" name="shipping_company"
                                            ...
                                            value="{{ $purchases->shipping_company }}" id="">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group mt-3">
                                        ...
                                        <input type="text" name="shipping_price"
                                            ...
                                            value="{{ $purchases->shipping_price }}" id="shippingPrice">
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <select name="shipping_status" class="form-control shadow-none @error('shipping_status') is-invalid @enderror" id="">
                                            ...
                                            <option value="ordered"
                                                {{ $purchases->shipping_status == 'ordered' ? 'selected' : '' }}>Ordered
                                            </option>
                                            <option value="recieved"
                                                {{ $purchases->shipping_status == 'recieved' ? 'selected' : '' }}>Recieved
                                            </option>
                                            <option value="pending"
                                                {{ $purchases->shipping_status == 'pending' ? 'selected' : '' }}>Pending
                                            </option>
                                        </select>
                                    ...
                                    <div class="card-head">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody id="product-list">
                                                ...
                                                @forelse ($purchases->purchaseproducts as $index => $purchaseproduct)
                                                    <tr>
                                                        <td style="width: 250px;">
                                                            <input type="text" name="purchaseproducts[{{$index}}][product_name]" class="form-control shadow-none" value="{{ $purchaseproduct->product_name }}" readonly required>
                                                            <input type="text" name="purchaseproducts[{{$index}}][product_id]" class="form-control shadow-none" value="{{ $purchaseproduct->product_id }}" readonly>
                                                        </td>
                                                        <td>
                                                            <textarea name="purchaseproducts[{{$index}}][specs_value]" class="form-control shadow-none" required>{{ $purchaseproduct->specs_value }}</textarea>
                                                            <textarea name="purchaseproducts[{{$index}}][specification_id]" class="form-control shadow-none" readonly>{{ $purchaseproduct->specification_id }}</textarea>
                                                        </td>
                                                        <td style="width: 100px;">
                                                            <input type="number" name="purchaseproducts[{{$index}}][qty]" class="form-control qty-input shadow-none" value="{{ $purchaseproduct->qty }}" required>
                                                        </td>
                                                        <td class="purchase-price" style="width: 150px;">
                                                            <input type="text" name="purchaseproducts[{{$index}}][purchase_price]" class="form-control shadow-none" readonly value="{{ $purchaseproduct->purchase_price }}" required>
                                                        </td>
                                                        <td style="width: 100px;">
                                                            <input type="text" name="purchaseproducts[{{$index}}][sale_price]" class="form-control shadow-none" readonly value="{{ $purchaseproduct->sale_price }}" required>
                                                        </td>
                                                        <td style="width: 200px;">
                                                            <input type="text" name="purchaseproducts[{{$index}}][status]" class="form-control shadow-none" readonly value="{{ $purchaseproduct->status }}" required>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <td colspan="2">
                                                        <input type="number" name="total_price"
                                                            class="form-control shadow-none @error('total_price')
                                                                is-invalid
                                                            @enderror" id="totalPrice" value="{{ $purchases->total_price }}" readonly>
                                                        @error('total_price')
                                                            <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <input type="text" name="paid_price"
                                                            class="form-control shadow-none @error('paid_price') is-invalid @enderror" value="{{ $purchases->paid_price }}" id="paidPrice">
                                                        @error('paid_price')
                                                            <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <input type="text" name="notpaid_price"
                                                            class="form-control shadow-none @error('notpaid_price') is-invalid @enderror" value="{{ $purchases->notpaid_price }}" id="notPaidPrice" readonly>
                                                    </td>
                                                </tr>
                                            </tfoot>
                                        </table>
